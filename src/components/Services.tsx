  ...
  const serviceItems = [
    {
      ...
      description:
        'Оперативный вывоз всех видов строительного мусора с объектов любой сложности.'
    },
    {
      icon: <Home className="h-10 w-10 text-[#3644b9]" />,
      title: 'Вывоз мусора после ремонта',
      description:
        'Чистота в квартире или офисе после ремонта без хлопот и забот.'
    },
    {
      icon: <Building2 className="h-10 w-10 text-[#3644b9]" />,
      title: 'Вывоз после демонтажа',
      description:
        'Быстрый вывоз после демонтажных работ любого масштаба и сложности.'
    },
    {
      icon: <Truck className="h-10 w-10 text-[#3644b9]" />,
      title: 'Предоставление контейнеров',
      description:
        'Контейнеры различного объема для временного хранения и вывоза мусора.'
    },
    {
      icon: <Package className="h-10 w-10 text-[#3644b9]" />,
      title: 'Погрузка мусора',
      description:
        'Услуги грузчиков для быстрой и эффективной погрузки строительного мусора.'
    },
    {
      icon: <Leaf className="h-10 w-10 text-[#3644b9]" />,
      title: 'Экологичная утилизация',
      description:
        'Утилизация строительных отходов с соблюдением всех экологических норм.'
    }
  ]
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Профессиональный вывоз строительного мусора для частных лиц и
            организаций. Работаем быстро, чисто и по доступным ценам.
          </p>
        </div>
